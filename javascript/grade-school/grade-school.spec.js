...
describe('School', function () {
    ...
    it('doesn\'t accept wrong arguments', function () {
        expect(function () { school.add('Aimee', '2'); }).toThrow('Invalid argument');
        expect(function () { school.add(0, 2); }).toThrow('Invalid argument');
        expect(function () { school.add(null, 2); }).toThrow('Invalid argument');
        expect(function () { school.add(); }).toThrow('Invalid argument');
        expect(function () { school.grade('Aimee'); }).toThrow('Invalid argument');
        expect(function () { school.grade(null); }).toThrow('Invalid argument');
    });
